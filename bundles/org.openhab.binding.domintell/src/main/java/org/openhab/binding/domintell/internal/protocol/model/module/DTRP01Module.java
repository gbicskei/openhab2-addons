...
/**
 * The {@link DTRP01Module} class is model class for DTRP01 Domintell module
 *
 * @author Gabor Bicskei - Initial contribution
 */
@NonNullByDefault
public class DTRP01Module extends ReleyModule {
    public DTRP01Module(DomintellConnection connection, SerialNumber serialNumber) {
        super(connection, ModuleType.TRP, serialNumber, 4);
    }
}

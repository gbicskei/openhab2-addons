...
public enum ActionType {
    ...
    SET_SHUTTER(false, false, false, false, "%H"),
    RESET_SHUTTER(false, false, false, false, "%L"),
    STOP_SHUTTER(false, false, false, false, "%O"),
    ...
    DOUBLE_PUSH(false, false, false, true, "%I", "%O", "%I", "%O"),
    ...
    ActionType(boolean decimalValueNeeded, boolean temperatureValueNeeded, boolean frequencyValueNeeded,
            boolean selectionValueNeeded) {
        this(decimalValueNeeded, temperatureValueNeeded, frequencyValueNeeded, selectionValueNeeded, "");
    }

    ActionType(boolean decimalValueNeeded, boolean temperatureValueNeeded, boolean frequencyValueNeeded,
            boolean selectionValueNeeded, String... actionString) {
        ...
        this.actionString = actionString.length > 0 ? actionString : new String[0];
    }

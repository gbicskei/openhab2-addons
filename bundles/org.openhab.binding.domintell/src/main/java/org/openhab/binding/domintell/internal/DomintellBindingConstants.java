...
public class DomintellBindingConstants {
    public static final String BINDING_ID = "domintell";
    ...
    static final Set<ThingTypeUID> SUPPORTED_GROUP_THING_TYPES_UIDS = Stream.of(THING_TYPE_GROUP)
    ...
    public static final String CHANNEL_BUTTONTRIGGER = "buttonTrigger";

    public static final ChannelTypeUID CHANNEL_TYPE_VARIABLE_NUM = new ChannelTypeUID(BINDING_ID, CHANNEL_NUMERIC_VAR);
    public static final ChannelTypeUID CHANNEL_TYPE_VARIABLE_BOOLEAN = new ChannelTypeUID(BINDING_ID,
            CHANNEL_BOOLEAN_VAR);
    public static final ChannelTypeUID CHANNEL_TYPE_CONTACT = new ChannelTypeUID(BINDING_ID, CHANNEL_CONTACT);
    public static final ChannelTypeUID CHANNEL_TYPE_BUTTON_TRIGGER = new ChannelTypeUID(BINDING_ID,
            CHANNEL_BUTTONTRIGGER);

    // config
    public static final String CONFIG_SERIAL_NUMBER = "serialNumber";
    public static final String CONFIG_MODULE_TYPE = "moduleType";
    public static final String CONFIG_CONTACT_INDEX = "contactIdx";
}

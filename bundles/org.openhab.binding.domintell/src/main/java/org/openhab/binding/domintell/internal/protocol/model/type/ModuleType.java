...
/**
 * The {@link ModuleType} is module type enumeration. Only types with implementation classes are supported by the
 * binding.
 *
...
public enum ModuleType {
    ...
    TRV(DTRV01Module.class), // 4 shutter inverters Bit 0 Relay 1 = UP Bit 1 Relay 1 = DOWN
    ...
    public @Nullable Class<? extends Module> getClazz() {
        return clazz;
    }
}

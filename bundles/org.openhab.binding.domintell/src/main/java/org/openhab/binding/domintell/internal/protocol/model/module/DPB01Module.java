...
/**
 * The {@link DPB01Module} class is handling physical push button module DPB(U/T)01
 *
 * @author Gabor Bicskei - Initial contribution
 */
@NonNullByDefault
public class DPB01Module extends PushButtonModule {
    /**
     * Constructor
     *
     ...
     */
    public DPB01Module(DomintellConnection connection, SerialNumber serialNumber) {
        super(connection, ModuleType.BU1, serialNumber, 1);
    }
}
